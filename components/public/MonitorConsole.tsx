...
export default function MonitorConsole({
  ...
  return (
    <>
      ...
      {/* Desktop Layout (>= lg) */}
      <div className="hidden lg:flex h-full flex-col p-4 md:p-6 lg:p-8 font-mono text-xs md:text-sm text-green-500 overflow-hidden">
        {/* HEADER SECTION */}
            ...
            <div className="flex-none border border-green-500/30 bg-green-500/5 p-1 relative group">
              ...
              <div className="flex flex-col bg-black/40">
                ...
                <div className="flex items-start p-4 gap-6">
                  {/* Avatar Box */}
                  <div className="relative h-28 w-28 shrink-0 border border-green-500/50 p-1">
                  ...
                  <div className="flex-1 space-y-1 text-xs">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs">{roleTitle ?? "ENGINEER"}</span>
                    </div>
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      <a
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-[11px] uppercase font-bold transition-all duration-300 ${!profile?.cv_pdf_url
                            ? 'opacity-50 cursor-not-allowed border border-green-500/20 text-green-500/50'
                            : 'bg-green-500 text-black border-2 border-green-400 shadow-[0_0_20px_rgba(34,197,94,0.5)] hover:shadow-[0_0_30px_rgba(34,197,94,0.8)] hover:scale-105'
                          }`}
                      >
                        <FileDown className="h-4 w-4" />
                        {profile?.cv_pdf_url ? "DOWNLOAD_CV.PDF" : "CV_NOT_AVAILABLE"}
                      </a>
                    </div>
                  </div>
                </div>
        ...
        <footer className="flex-none border-t border-green-500/30 pt-2 mt-4 flex justify-between text-[10px] text-green-500/70">
          <span className="truncate">STATUS: NOMINAL // SECURITY LEVEL: 4</span>
        </footer>
      </div>
    </>
  )
